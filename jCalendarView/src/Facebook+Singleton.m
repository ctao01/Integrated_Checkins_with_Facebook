...
- (void)authorize {
    ...
    if (![self isSessionValid]) {
        ...
        NSArray *permissions = [[NSArray alloc] initWithObjects:
                                @"email", @"user_status",@"user_photos",@"user_checkins", @"user_birthday", @"user_about_me",@"user_activities", 
                                @"read_friendlists", @"friends_checkins", @"friends_status",
                                @"publish_checkins",@"publish_stream", @"read_stream",
                                @"offline_access",
                                nil];
